...
# DVE full session
# Saved on Mon Dec 8 02:41:39 2025
# Designs open: 1
...
#<Session mode="Full" path="/home/infty/ic/systemverilog/convergroup_test/DVEfiles/session.tcl" type="Coverage">
...
gui_show_window -window ${CovTopLevel.1} -show_state maximized -rect {{72 64} {1679 1049}}
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 199} {height 722} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 140} {child_covhier_coltype 100} {child_covhier_col1 1} {child_covhier_col2 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1607} {height 179} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${CoverageTable.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {Layout_CoverageTable_covtblFGroupsList_names Group,    , ,  ,   ,Score,Covergroup,} {Layout_CoverageTable_covtblFGroupsList_widths 220,0,25,0,0,125,125,} {Layout_CoverageTable_covtblFGroupsList_orders 4,0,1,2,3,5,6,} {Layout_CoverageTable_covtblInstancesList_names Name,    , ,  ,   ,Score,} {Layout_CoverageTable_covtblInstancesList_widths 220,0,25,0,0,125,} {Layout_CoverageTable_covtblInstancesList_orders 4,0,1,2,3,5,} {Layout_CoverageTable_covtblModulesList_names Name,    , ,  ,   ,Score,} {Layout_CoverageTable_covtblModulesList_widths 220,0,25,0,0,125,} {Layout_CoverageTable_covtblModulesList_orders 4,0,1,2,3,5,}}
...
gui_open_cov  -hier {build/coverage.vdb/}   -testdir {build/coverage.vdb/} -autoopen False  -test { {build/coverage/test} } -merge {MergedTest}
